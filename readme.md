...
[Do not put PHP tag in the blade file](#do-not-put-php-code-in-the-blade-file)
...
### **Do not put PHP tag in the blade file**
...
Minimize usage of PHP in Blade templates.
